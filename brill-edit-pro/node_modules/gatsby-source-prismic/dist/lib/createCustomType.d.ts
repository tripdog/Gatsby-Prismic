 ...
 */
export declare const createCustomType: (name: string, schema: prismicT.CustomTypeModelDefinition) => RTE.ReaderTaskEither<Dependencies, never, gatsby.GatsbyGraphQLObjectType>;
