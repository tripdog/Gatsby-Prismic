 ...
 * @since 0.1.0
 */
export declare const lpadZipWith: <A, B, C>(xs: Array<A>, ys: Array<B>, f: (a: Option<A>, b: B) => C) => Array<C>
/**
 ...
 * @since 0.1.0
 */
export declare const lpadZip: <A, B>(xs: Array<A>, ys: Array<B>) => Array<[Option<A>, B]>
/**
 * Apply a function to pairs of elements at the same index in two arrays, collecting the results in a new array. If the
 ...
 * @since 0.1.0
 */
export declare const rpadZipWith: <A, B, C>(xs: Array<A>, ys: Array<B>, f: (a: A, b: Option<B>) => C) => Array<C>
/**
 ...
 * @since 0.1.0
 */
export declare const rpadZip: <A, B>(xs: Array<A>, ys: Array<B>) => Array<[A, Option<B>]>
